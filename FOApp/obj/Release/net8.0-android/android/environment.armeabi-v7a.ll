...
@dso_cache = dso_local local_unnamed_addr global [1052 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 314439684, ; hash 0x12bdf804, from name: libaot-FOApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 455358486, ; hash 0x1b243816, from name: aot-Google.Maps.Utils.Android
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 515182489, ; hash 0x1eb50f99, from name: Google.Maps.Utils.Android
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.82_name, ; name: libaot-Google.Maps.Utils.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	...
	%struct.DSOCacheEntry {
		i64 544135633, ; hash 0x206ed9d1, from name: libaot-Maui.GoogleMaps.Clustering
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 646708765, ; hash 0x268bfe1d, from name: libaot-Google.Maps.Utils.Android.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.82_name, ; name: libaot-Google.Maps.Utils.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 154
	...
	%struct.DSOCacheEntry {
		i64 1059396508, ; hash 0x3f251b9c, from name: Maui.GoogleMaps.Clustering.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Maui.GoogleMaps.Clustering.dll.so
		ptr null; void* handle (0x0)
	}, ; 232
	...
	%struct.DSOCacheEntry {
		i64 1066841966, ; hash 0x3f96b76e, from name: aot-Google.Maps.Utils.Android.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.82_name, ; name: libaot-Google.Maps.Utils.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 235
	...
	%struct.DSOCacheEntry {
		i64 1276684945, ; hash 0x4c18aa91, from name: Maui.GoogleMaps.Clustering
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Maui.GoogleMaps.Clustering.dll.so
		ptr null; void* handle (0x0)
	}, ; 278
	...
	%struct.DSOCacheEntry {
		i64 1320225650, ; hash 0x4eb10b72, from name: libaot-Google.Maps.Utils.Android
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.82_name, ; name: libaot-Google.Maps.Utils.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 287
	...
	%struct.DSOCacheEntry {
		i64 1930272249, ; hash 0x730d9df9, from name: aot-Maui.GoogleMaps.Clustering
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Maui.GoogleMaps.Clustering.dll.so
		ptr null; void* handle (0x0)
	}, ; 449
	...
	%struct.DSOCacheEntry {
		i64 2167243691, ; hash 0x812d83ab, from name: libaot-FOApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-FOApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 509
	...
	%struct.DSOCacheEntry {
		i64 2506132995, ; hash 0x95608e03, from name: aot-FOApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-FOApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 599
	...
	%struct.DSOCacheEntry {
		i64 2938432189, ; hash 0xaf24eabd, from name: aot-Maui.GoogleMaps.Clustering.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Maui.GoogleMaps.Clustering.dll.so
		ptr null; void* handle (0x0)
	}, ; 711
	...
	%struct.DSOCacheEntry {
		i64 3261473381, ; hash 0xc2662265, from name: libaot-Maui.GoogleMaps.Clustering.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Maui.GoogleMaps.Clustering.dll.so
		ptr null; void* handle (0x0)
	}, ; 800
	...
	%struct.DSOCacheEntry {
		i64 3330272589, ; hash 0xc67fed4d, from name: FOApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-FOApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 818
	...
	%struct.DSOCacheEntry {
		i64 3625275028, ; hash 0xd8154e94, from name: Google.Maps.Utils.Android.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.82_name, ; name: libaot-Google.Maps.Utils.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 888
	...
	%struct.DSOCacheEntry {
		i64 3904655449, ; hash 0xe8bc5059, from name: aot-FOApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-FOApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 946
	...
	%struct.DSOCacheEntry {
		i64 4213983375, ; hash 0xfb2c488f, from name: FOApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-FOApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 1026
